 ...
 * @since    19 May 2011
 */
public class CheckTemplateFillerActivityHealthChecker implements
		HealthChecker<CheckTemplateFillerActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof CheckTemplateFillerActivity;
	}
	...
	public VisitReport visit(CheckTemplateFillerActivity activity, List<Object> ancestry) {
		CheckTemplateFillerActivityConfigurationBean config = activity.getConfiguration();
