 ...
 * @since    19 May 2011
 */
public class TemplateFillerActivityHealthChecker implements
		HealthChecker<TemplateFillerActivity> {
	...
	public boolean canVisit(Object o) {
		...
		return o instanceof TemplateFillerActivity;
	}
	...
	public VisitReport visit(TemplateFillerActivity activity, List<Object> ancestry) {
		TemplateFillerActivityConfigurationBean config = activity.getConfiguration();
