package uk.org.taverna.astro.astrotaverna;
...
public class AstroActivity extends
		AbstractAsynchronousActivity<AstroActivityConfigurationBean>
		implements AsynchronousActivity<AstroActivityConfigurationBean> {
	...
	private AstroActivityConfigurationBean configBean;

	@Override
	public void configure(AstroActivityConfigurationBean configBean)
...
//					callback.fail("Could not invoke Astro service " + configBean.getExampleUri(),
//							ex);
...
//				}
	...
	@Override
	public AstroActivityConfigurationBean getConfiguration() {
