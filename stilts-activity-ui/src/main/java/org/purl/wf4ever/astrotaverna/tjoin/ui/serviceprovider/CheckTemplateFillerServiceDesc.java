...
public class CheckTemplateFillerServiceDesc extends ServiceDescription<CheckTemplateFillerActivityConfigurationBean> {
	 ...
	 */
	@Override
	public Class<? extends Activity<CheckTemplateFillerActivityConfigurationBean>> getActivityClass() {
		return CheckTemplateFillerActivity.class;
	}
	 ...
	 */
	@Override
	public CheckTemplateFillerActivityConfigurationBean getActivityConfiguration() {
		CheckTemplateFillerActivityConfigurationBean bean = new CheckTemplateFillerActivityConfigurationBean();
