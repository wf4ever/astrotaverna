...
public class TemplateFillerServiceDesc extends ServiceDescription<TemplateFillerActivityConfigurationBean> {
	 ...
	 */
	@Override
	public Class<? extends Activity<TemplateFillerActivityConfigurationBean>> getActivityClass() {
		return TemplateFillerActivity.class;
	}
	 ...
	 */
	@Override
	public TemplateFillerActivityConfigurationBean getActivityConfiguration() {
		TemplateFillerActivityConfigurationBean bean = new TemplateFillerActivityConfigurationBean();
