...
public class AstroServiceDesc extends ServiceDescription<AstroActivityConfigurationBean> {
	 ...
	 */
	@Override
	public Class<? extends Activity<AstroActivityConfigurationBean>> getActivityClass() {
		return AstroActivity.class;
	}
	 ...
	 */
	@Override
	public AstroActivityConfigurationBean getActivityConfiguration() {
		AstroActivityConfigurationBean bean = new AstroActivityConfigurationBean();
	...
	@Override
	public Icon getIcon() {
		return AstroServiceIcon.getIcon();
	}
	...
	public List<String> getPath() {
		...
		return Arrays.asList("Astros " + exampleUri);
	}
