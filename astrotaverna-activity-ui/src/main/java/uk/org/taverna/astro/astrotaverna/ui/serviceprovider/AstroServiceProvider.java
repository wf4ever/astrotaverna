...
public class AstroServiceProvider implements ServiceDescriptionProvider {
	
	private static final URI providerId = URI
		.create("http://example.com/2011/service-provider/astrotaverna");
	...
	public void findServiceDescriptionsAsync(
		...
		// of dummy for-loop
		for (int i = 1; i <= 5; i++) {
			AstroServiceDesc service = new AstroServiceDesc();
